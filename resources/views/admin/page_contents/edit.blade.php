          ...
          <div class="table-responsive overflow-hidden">  
               <form name="formEdit" id="frmEdit" action="{{route('admin.page_contents.update',$page_content->id)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="short_desc" class="form-control" name="short_desc">{{old('short_desc',$page_content->short_desc)}}</textarea>
                </div>
                <div class="form-group">
                    <label>Long Content</label>
                    <textarea id="long_desc" class="form-control" name="long_desc">{{old('long_desc',$page_content->long_desc)}}</textarea>
                </div>                
